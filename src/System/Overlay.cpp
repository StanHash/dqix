...
EXTERN_C void func_020c805c(struct Unk_data_01ffd34c*);
EXTERN_C void func_020a18d4(signed char*);
EXTERN_C void func_020cd0f4(struct Unk_data_01ffd394*, int, int);

EXTERN_C void func_020a1bb4(unsigned int overlayID);
EXTERN_C void func_020d9834(int arg_0);
EXTERN_C void func_020d970c(void);
EXTERN_C void func_020cd27c(struct Unk_data_01ffd394*);
EXTERN_C void func_020cd3a0(struct Unk_data_01ffd394*);
EXTERN_C void func_020d974c(void);
EXTERN_C void func_020c8074(struct Unk_data_01ffd34c*);
EXTERN_C void func_020c80f8(struct Unk_data_01ffd34c*);

EXTERN_C void func_020a1838(void) {
...
EXTERN_C void func_020a18d4(signed char* slots) {
    unsigned int i = 0;
...
EXTERN_C BOOL func_020a18f4(unsigned int overlayID) {
    int result = FALSE;
